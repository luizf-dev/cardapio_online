<?php if(!class_exists('Rain\Tpl')){exit;}?><main>
    ...
    <div class="lista">
        ...
        <div class="produto">
            ...
            <div class="actions">
                <a class="btn" href="/cardapio_online/cadastrar-imagem/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/new/"> + Cadastrar / Atualizar Imagem</a>
                ...
                <a href="/cardapio_online/atualizar-produto/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/" class="icon edit">
